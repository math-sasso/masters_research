...
class CountryRasterProcessor(object):
  def __init__(self,country_limits:Tuple,security_limit:int=1) -> None:
    super().__init__():
    
    #Country Limits
    self.security_limit = security_limit
    self.country_limits = country_limits
    self.x_min_limit = country_limits[0] -self.security_limit # DMS Coords: 07°32′39″S 073°59′04″W; Decimal Coords Geohack: -7.544167, -73.984444; Corrdenada Decimal epsg.io: -7.535403, -73.981934
    self.x_max_limit = country_limits[1] +self.security_limit # DMS Coords: 07°09′28″S 034°47′38″W; Decimal Coords Geohack: -20.474444, -28.840556; Corrdenada Decimal epsg.io: -7.155017, -34.792929
    self.y_min_limit = country_limits[2] -self.security_limit # DMS Coords: 33°45′09″S 053°22′07″W; Decimal Coords Geohack: -33.7525, -53.368611; Corrdenada Decimal epsg.io: -33.750035, -53.407288
    self.y_max_limit = country_limits[3] +self.security_limit # DMS Coords: 05°15′05″N 060°12′33″W; Decimal Coords Geohack: 5.251389, -60.209167; Corrdenada Decimal epsg.io: 5.271478, -60.214691  
    self.country_limits_secure = (self.x_min_limit,self.x_max_limit,self.y_min_limit,self.y_max_limit)
  ...
  def _get_window_from_extent(self,aff):
      ...
      """
      col_start, row_start = ~aff * (self.country_limits[0],self.country_limits[3])
      col_stop, row_stop = ~aff * (self.country_limits[1],self.country_limits[2])
      return ((int(row_start), int(row_stop)), (int(col_start), int(col_stop)))
  def standarize_raster_to_brazil_region(self,
                                          image_path:str,
    ...
    window_region = self._get_window_from_extent(src.meta['transform'])

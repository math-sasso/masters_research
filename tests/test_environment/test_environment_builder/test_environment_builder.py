...
from easy_sdm.dataset_creation import EnverionmentLayersStacker
...
def test_build_environment2(processed_raster_paths_list: Path):
    ...
    env_layer_stacker.stack_and_save(
        raster_path_list=processed_raster_paths_list, output_path=output_path
    )
    import pdb
